...
let programming_languages : string[] = ["C++", "JavaScript", "TypeScript", "Python"];

console.log("List of some programming languages");

programming_languages.forEach(language => console.log(language));
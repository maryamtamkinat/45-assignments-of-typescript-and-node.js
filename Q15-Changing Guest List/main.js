...
guestList.forEach(guest => console.log(`Hello ${guest},Today would you like to dinner with us`));
console.log("Ibad cant attend dinner");
guestList.splice(2, 1, "Ayesha");
guestList.forEach(name => console.log(`hello ${name} would you like to dinner with us?`));
